...
function stageIndex(config, stageId) {
  return config.stages.findIndex((s) => s.id === stageId);
}
function getStageByPromptPath(config, flowName, filePath) {
...
\u5982\u9700\u4FEE\u6539\uFF1A\u8BF7\u5728\u63A7\u5236\u8BE5\u6D41\u7A0B\u7684 session \u4E2D\u8FDB\u884C\uFF1B\u82E5\u9700\u7531\u672C session \u63A5\u7BA1\uFF0C\u6267\u884C /clear \u63A5\u7BA1\uFF08\u539F session \u5DF2\u4E0D\u5B58\u5728\u5374\u4ECD\u88AB\u9501\u5B9A\u65F6\uFF0C\u5148\u5C06 ${activeFile} \u7684 "last_session_id" \u6539\u4E3A null \u518D /clear\uFF09\u3002`
    ...
    if (READ_TOOLS.has(tool_name)) {
      ...
      if (!fp2) return null;
      const abs = resolvePath(repoRoot, fp2);
      ...
      if (targetStageId !== null) {
        ...
        if (targetIdx > currentIdx) {
          return deny(
            `Stage file '${targetStageId}' is ahead of the current stage '${state.current_stage}'. You may only read stage files for the current stage or earlier stages.`
          );
        }
      }
      return null;
