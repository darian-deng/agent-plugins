...
import { assertNoSwallowedHandlerErrors } from './fixtures/helpers.js';
...
// Runs after every test in every file: see assertNoSwallowedHandlerErrors.
afterEach(() => {
  assertNoSwallowedHandlerErrors();
});
