...
3. 检查是否有 SKILL.md 文件需要新增或修改（使用 `skill-surgeon` skill）
4. 在 `design.md` 末尾追加评估记录

**可选（复杂需求，约 15-20 分钟）：**

5. 记录 flow 过程中踩过的坑（技术债、错误预判、绕弯路的地方）
6. 检查是否有已存在的 rule 与实际代码不符，反向更新
...
- Skill 更新评估：<是否新增或修改了 SKILL.md，或无需>
- 失败教训：<本次踩坑记录，或无>
```
